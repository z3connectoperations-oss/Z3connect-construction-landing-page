...
export default function DetailFeatures() {
  return (
    <section className="py-12 md:py-24 space-y-16 md:space-y-32">
      {/* Feature 1 */}
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 md:gap-16 items-center">
        <div className="order-2 md:order-1 mt-8 md:mt-0">
          <img
            className="rounded-2xl md:rounded-[3rem] shadow-2xl"
        ...
        <div className="order-1 md:order-2">
          <span className="label-sm text-secondary font-black mb-3 md:mb-4 block">COST CONTROL</span>
          <h3 className="text-2xl md:text-4xl font-black mb-4 md:mb-6">Automated BOQ & Cost Tracking</h3>
          ...
          <div className="flex items-center gap-4 p-4 bg-surface-container rounded-xl md:rounded-2xl">
            <span className="material-symbols-outlined text-secondary" data-icon="trending_down">trending_down</span>
            <p className="text-xs md:text-sm font-bold">Reduce material wastage by 18% on average.</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 md:gap-16 items-center">
        <div className="order-1">
          <span className="label-sm text-secondary font-black mb-3 md:mb-4 block">LABOR MANAGEMENT</span>
          <h3 className="text-2xl md:text-4xl font-black mb-4 md:mb-6">GPS + Biometric Attendance</h3>
          <p className="text-base md:text-lg text-on-surface-variant leading-relaxed mb-6 md:mb-8">
          ...
          <ul className="space-y-3 md:space-y-4">
            <li className="flex items-center gap-2 font-semibold text-sm md:text-base">
