  ...
  return (
    <section className="px-6 py-24 bg-surface-container-low" id="features">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Card 1 */}
        <div className="bg-surface-container-lowest p-8 rounded-[2rem] hover:translate-y-[-4px] transition-transform duration-300">
          <div className="w-12 h-12 bg-green-100 text-green-600 rounded-xl flex items-center justify-center mb-6">
            <span className="material-symbols-outlined" data-icon="chat_bubble">chat_bubble</span>
          </div>
          <h3 className="text-xl font-bold mb-3">WhatsApp AI Sync</h3>
        ...
        <div className="bg-surface-container-lowest p-8 rounded-[2rem] hover:translate-y-[-4px] transition-transform duration-300">
          ...
          <h3 className="text-xl font-bold mb-3">Offline-First Sync</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed">
        ...
        <div className="bg-surface-container-lowest p-8 rounded-[2rem] hover:translate-y-[-4px] transition-transform duration-300">
          ...
          <h3 className="text-xl font-bold mb-3">GST & RERA Ready</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed">
        ...
        <div className="bg-surface-container-lowest p-8 rounded-[2rem] hover:translate-y-[-4px] transition-transform duration-300">
          ...
          <h3 className="text-xl font-bold mb-3">Flat Pricing Model</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed">
